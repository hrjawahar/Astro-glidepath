...
## Patch integration note
- The scoring engine is upgraded to the new v2 rule logic in `functions/api/analyze.js`.
- UI structure is kept intact.
- Combustion and planetary war are supported as **optional backend inputs** when longitude/latitude data is supplied later. With the current manual UI, those advanced checks stay dormant and do not break the app.
